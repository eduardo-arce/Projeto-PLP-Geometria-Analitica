...
public class Imp2Parser implements Imp2ParserConstants {
  ...
  static final public Expressao PExpIdentity() throws ParseException {
    trace_call("PExpIdentity");
    try {
    Expressao size;
      jj_consume_token(IDENTITY);
      size = PExpressao();
        {if (true) return new ExpIdentity(size);}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("PExpIdentity");
    }
  }

  static final public Expressao PExpTranspose() throws ParseException {
    trace_call("PExpTranspose");
    try {
    Expressao matrix;
      jj_consume_token(TRANSPOSE);
      matrix = PExpressao();
        {if (true) return new ExpTranspose(matrix);}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("PExpTranspose");
    }
  }

  static final public Expressao PExpDist() throws ParseException {
    trace_call("PExpDist");
    try {
    Expressao matrix;
      jj_consume_token(DIST);
      matrix = PExpressao();
        {if (true) return new ExpDist(matrix);}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("PExpDist");
    }
  }

  static final public Expressao PExpPm() throws ParseException {
    trace_call("PExpPm");
    try {
    Expressao matrix;
      jj_consume_token(PM);
      matrix = PExpressao();
        {if (true) return new ExpPm(matrix);}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("PExpPm");
    }
  ...
  static final public Expressao PExpAng() throws ParseException {
    trace_call("PExpAng");
    try {
    Expressao matrix;
      jj_consume_token(ANG);
      matrix = PExpressao();
        {if (true) return new ExpAng(matrix);}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("PExpAng");
    }
  }

  static final public Expressao PExpRad2Graus() throws ParseException {
    trace_call("PExpRad2Graus");
    try {
    Expressao matrix;
      jj_consume_token(RAD2GRAUS);
      matrix = PExpressao();
        {if (true) return new ExpRad2Graus(matrix);}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("PExpRad2Graus");
    }
  }

  static final public Expressao PExpGraus2Rad() throws ParseException {
    trace_call("PExpGraus2Rad");
    try {
    Expressao matrix;
      jj_consume_token(GRAUS2RAD);
      matrix = PExpressao();
        {if (true) return new ExpGraus2Rad(matrix);}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("PExpGraus2Rad");
    }
  }
  ...
  static final public Expressao PExpUnaria() throws ParseException {
    ...
    try {
      ...
      case LENGTH:
        ...
        break;
      case IDENTITY:
        retorno = PExpIdentity();
        break;
      case TRANSPOSE:
        retorno = PExpTranspose();
        break;
      case DIST:
        retorno = PExpDist();
        break;
      ...
      case PM:
        ...
        break;
      case GRAUS2RAD:
        retorno = PExpGraus2Rad();
        break;
      case RAD2GRAUS:
        retorno = PExpRad2Graus();
        break;
      default:
        jj_la1[5] = jj_gen;
        jj_consume_token(-1);
  ...
  static final public Expressao PExpBinaria() throws ParseException {
    ...
    try {
      ...
      if (jj_2_2(2147483647)) {
        ...
        retorno = PExpSomaMatriz();
      } else if (jj_2_10(2147483647)) {
        retorno = PExpMultMatriz();
  ...
  static final public ExpDiv PExpDiv() throws ParseException {
    trace_call("PExpDiv");
    try {
        Expressao esq;
        Expressao dir;
      ...
      dir = PExpressao();
         {if (true) return new ExpDiv(esq, dir);}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("PExpDiv");
    }
  }

  static final public ExpSomaMatriz PExpSomaMatriz() throws ParseException {
    trace_call("PExpSomaMatriz");
    try {
        Expressao esq;
        Expressao dir;
      esq = PExpPrimaria();
      jj_consume_token(M_PLUS);
      dir = PExpressao();
         {if (true) return new ExpSomaMatriz(esq, dir);}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("PExpSomaMatriz");
    }
  }
  ...
  static final public ExpSubMatriz PExpSubMatrix() throws ParseException {
    trace_call("PExpSubMatrix");
    try {
        Expressao esq;
        Expressao dir;
      esq = PExpPrimaria();
      jj_consume_token(M_MINUS);
      dir = PExpressao();
         {if (true) return new ExpSubMatriz(esq, dir);}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("PExpSubMatrix");
    }
  }
  ...
  static final public ExpMulti PExpMult() throws ParseException {
    trace_call("PExpMult");
    try {
        Expressao esq;
        Expressao dir;
      ...
      dir = PExpressao();
         {if (true) return new ExpMulti(esq, dir);}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("PExpMult");
    }
  }

  static final public ExpMultiMatrix PExpMultMatriz() throws ParseException {
    trace_call("PExpMultMatriz");
    try {
        Expressao esq;
        Expressao dir;
      esq = PExpPrimaria();
      jj_consume_token(M_MULT);
      dir = PExpressao();
         {if (true) return new ExpMultiMatrix(esq, dir);}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("PExpMultMatriz");
    }
  }

  static final public ExpMatriz PExpMatriz() throws ParseException {
    trace_call("PExpMatriz");
    try {
 Expressao exp;
 ArrayList<ArrayList<Expressao>> lista = new ArrayList<ArrayList<Expressao>>();
 lista.add(new ArrayList<Expressao>());
 int i = 0;
      ...
      while (true) {
        ...
        case BIT_OR:
          jj_consume_token(BIT_OR);
                                                                                 i++; lista.add(new ArrayList<Expressao>());
          break;
        default:
          jj_la1[7] = jj_gen;
          jj_consume_token(-1);
      ...
      jj_consume_token(RBRACKET);
        ...
        {if (true) return new ExpMatriz(lista);}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("PExpMatriz");
    }
  }
...
/*  ADICIONADO OU MODIFICADO DA Imperativa1 PARA A Imperativa2  */
  ...
  static private boolean jj_3R_51() {
    if (jj_scan_token(ANG)) return true;
    if (jj_3R_32()) return true;
    return false;
  }
  ...
  static private boolean jj_3R_104() {
    if (jj_3R_5()) return true;
    if (jj_scan_token(M_MINUS)) return true;
    if (jj_3R_32()) return true;
    return false;
  }
  ...
  static private boolean jj_3R_109() {
    if (jj_3R_5()) return true;
    if (jj_scan_token(M_PLUS)) return true;
    if (jj_3R_32()) return true;
    return false;
  }
  ...
  static private boolean jj_3_10() {
    if (jj_3R_5()) return true;
    if (jj_scan_token(M_MULT)) return true;
    return false;
  }
  ...
  static private boolean jj_3R_53() {
    if (jj_scan_token(GRAUS2RAD)) return true;
    if (jj_3R_32()) return true;
    return false;
  }
  ...
  static private boolean jj_3R_54() {
    if (jj_scan_token(RAD2GRAUS)) return true;
    if (jj_3R_32()) return true;
    return false;
  }
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x3b0000,0x180000,0x6000,0x6000,0x6000,0x7f001800,0x0,0x0,0x6000,0x3b0000,0x80008000,0x80000000,0x0,0x0,0x0,0x0,0x7f007800,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x29001,0x0,0x0,0xc40,0x89c40,0x0,0x400000,0x400000,0x89c40,0x29001,0x8000,0x0,0x43002e,0x2e,0x2e,0x400000,0x89c40,0x400000,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x0,0x100,0x1000,0x1000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x100,0x0,};
   }

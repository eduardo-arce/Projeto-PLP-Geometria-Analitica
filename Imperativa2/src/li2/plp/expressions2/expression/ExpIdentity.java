...
public class ExpIdentity extends ExpUnaria{
     ...
     */
    public ExpIdentity(Expressao exp) {
        super(exp, "identity");
    }
    ...
    public ExpUnaria clone() {
        return new ExpIdentity(exp.clone());
    }
    ...
    public Valor avaliar(AmbienteExecucao amb) throws VariavelNaoDeclaradaException, VariavelJaDeclaradaException, IncompatibleMatrixSizesException {
        int size = ((ValorInteiro) getExp().avaliar(amb)).valor();
        return new ValorMatriz(Matriz.identidade(size));
    }
